...
- `electrolyte`: AGM, GEL, або LAB (None якщо не вказаний)
- `volume`: ємність в Ah, якщо не вказано ніяких букв то подумай логічно яке з цих значень найбільш наближене і реальне до емкості(якщо геть все погано то поверни None)
