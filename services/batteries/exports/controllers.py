...
from services.batteries.helpers.ai_csv_parse import ai_parser as csv_ai_parser
from helpers.ai_req import gemini_request
from http import HTTPStatus
from services.batteries.helpers.import_data import import_data
from services.batteries.helpers.ai_html_parse import ai_parser as html_ai_parser
from prompts.batteries.parse_txt_prompt import parse_txt_prompt
...
async def parse_my_batteries(parse_func, supplier_name):
    html_data = await parse_func()
    ai_data = await html_ai_parser(html_data)
